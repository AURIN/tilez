...
exports.transform = [
    {
      tileMin : [ 0, 0, 0 ],
      tileMax : [ 0, 1, -1 ],
      bbox : [ -179.99997854238, -85.05113891866661,
              180.00002145762, 85.0511186409466 ]
    },
    {
      tileMin : [ 8, 230, 157 ],
      tileMax : [ 8, 231, 157 ],
      tileMin2 : [ 8, 230, 158 ],
      tileMax2 : [ 8, 231, 156 ],
      bbox : [ 143.43748290095905, -38.82259560417936,
              144.84376726667858, -37.7185858291927 ]
    },
    {
      tileMin : [ 3, 6, 5 ],
      tileMax : [ 3, 7, 4 ],
      tileMin2 : [ 3, 6, 6 ],
      tileMax2 : [ 3, 7, 5 ],
      bbox : [ 89.99998927119, -66.51326837209112,
              135.000016093215, -40.979893184447455 ]
    },
    {
      ...
      bbox : [ 7.5585928489475975, 47.47266852778209,
              7.564087815769737, 47.476370137598046 ]
    },
    {
      ...
      bbox : [ 13.375852897665261, 52.516227124336915,
              13.378602669068405, 52.51788596777742 ]
    } ];
...
exports.pg = {
  test1 : 'SELECT ST_AsGeoJSON(ST_Transform(ST_Intersection(the_geom, ST_Transform(ST_GeomFromText(\'POLYGON((179.99997854238 -89.99076324419666, 360.00004291524 -89.99076324419666, 360.00004291524 -89.78599637143668, 179.99997854238 -89.78599637143668, 179.99997854238 -89.99076324419666))\', 4326), 4283)), 4283), 15) AS geom, id AS id, name as feature_name FROM psma.vic_street_line_joined_shp_gen0_05 WHERE ST_Intersects(the_geom, ST_Transform(ST_GeomFromText(\'POLYGON((179.99997854238 -89.99076324419666, 360.00004291524 -89.99076324419666, 360.00004291524 -89.78599637143668, 179.99997854238 -89.78599637143668, 179.99997854238 -89.99076324419666))\', 4326), 4283))',
  test2 : 'SELECT ST_AsGeoJSON(ST_Transform(ST_Intersection(the_geom, ST_Transform(ST_GeomFromText(\'POLYGON((179.99997854238 -90.00001072881, 360.00004291524 -90.00001072881, 360.00004291524 -89.99998927119, 179.99997854238 -89.99998927119, 179.99997854238 -90.00001072881))\', 4326), 4283)), 4283), 15) AS geom, id AS id, name as feature_name FROM psma.vic_street_line_joined_shp_gen0_05 WHERE ST_Intersects(the_geom, ST_Transform(ST_GeomFromText(\'POLYGON((179.99997854238 -90.00001072881, 360.00004291524 -90.00001072881, 360.00004291524 -89.99998927119, 179.99997854238 -89.99998927119, 179.99997854238 -90.00001072881))\', 4326), 4283))',
  test3 : 'SELECT ST_AsGeoJSON(ST_Transform(ST_Intersection(the_geom, ST_Transform(ST_GeomFromText(\'POLYGON((144.90415753080572 -37.792426913185444, 144.90968524328662 -37.792426913185444, 144.90968524328662 -37.78807687944107, 144.90415753080572 -37.78807687944107, 144.90415753080572 -37.792426913185444))\', 4326), 4326)), 3857), 15) AS geom, id AS id, name FROM psma.XXX_vic_street_line_joined_shp_gen0_0001 WHERE ST_Intersects(the_geom, ST_Transform(ST_GeomFromText(\'POLYGON((144.90415753080572 -37.792426913185444, 144.90968524328662 -37.792426913185444, 144.90968524328662 -37.78807687944107, 144.90415753080572 -37.78807687944107, 144.90415753080572 -37.792426913185444))\', 4326), 4326))',
  test4 : 'SELECT ST_AsGeoJSON(ST_Transform(ST_Intersection(the_geom, ST_Transform(ST_GeomFromText(\'POLYGON((179.99997854238 -89.99076324419666, 360.00004291524 -89.99076324419666, 360.00004291524 -89.78599637143668, 179.99997854238 -89.78599637143668, 179.99997854238 -89.99076324419666))\', 4326), 4283)), 3857), 15) AS geom, idAlt AS id, nameAlt FROM abs_asgc.lga06gen0_05 WHERE ST_Intersects(the_geom, ST_Transform(ST_GeomFromText(\'POLYGON((179.99997854238 -89.99076324419666, 360.00004291524 -89.99076324419666, 360.00004291524 -89.78599637143668, 179.99997854238 -89.78599637143668, 179.99997854238 -89.99076324419666))\', 4326), 4283))',
  test5 : 'SELECT ST_AsGeoJSON(ST_Transform(ST_Intersection(the_geom, ST_Transform(ST_GeomFromText(\'POLYGON((179.99997854238 -89.99961110876491, 360.00004291524 -89.99961110876491, 360.00004291524 -89.99074178878142, 179.99997854238 -89.99074178878142, 179.99997854238 -89.99961110876491))\', 4326), 4283)), 4283), 15) AS geom, id AS id, name as feature_name FROM psma.vic_street_line_joined_shp_gen0_05 WHERE ST_Intersects(the_geom, ST_Transform(ST_GeomFromText(\'POLYGON((179.99997854238 -89.99961110876491, 360.00004291524 -89.99961110876491, 360.00004291524 -89.99074178878142, 179.99997854238 -89.99074178878142, 179.99997854238 -89.99961110876491))\', 4326), 4283))',
  ...
  test13 : "ROLLBACK",
  test14 : 'SELECT ST_AsGeoJSON(ST_Transform(ST_Intersection(the_geom, ST_Transform(ST_GeomFromText(\'POLYGON((179.99997854238 -90.00001072881, 360.00004291524 -90.00001072881, 360.00004291524 -89.99998927119, 179.99997854238 -89.99998927119, 179.99997854238 -90.00001072881))\', 4326), 4326)), 3857), 15) AS geom, name AS id FROM abs_asgc.xxxlga06gen0_05 WHERE ST_Intersects(the_geom, ST_Transform(ST_GeomFromText(\'POLYGON((179.99997854238 -90.00001072881, 360.00004291524 -90.00001072881, 360.00004291524 -89.99998927119, 179.99997854238 -89.99998927119, 179.99997854238 -90.00001072881))\', 4326), 4326))',
  test15 : 'SELECT ST_AsGeoJSON(ST_Transform(ST_Intersection(the_geom, ST_Transform(ST_GeomFromText(\'POLYGON((179.99997854238 -89.99961110876491, 360.00004291524 -89.99961110876491, 360.00004291524 -89.99074178878142, 179.99997854238 -89.99074178878142, 179.99997854238 -89.99961110876491))\', 4326), 4283)), 3857), 15) AS geom, idAlt AS id, nameAlt FROM abs_asgc.lga06gen0_05 WHERE ST_Intersects(the_geom, ST_Transform(ST_GeomFromText(\'POLYGON((179.99997854238 -89.99961110876491, 360.00004291524 -89.99961110876491, 360.00004291524 -89.99074178878142, 179.99997854238 -89.99074178878142, 179.99997854238 -89.99961110876491))\', 4326), 4283))'
};
